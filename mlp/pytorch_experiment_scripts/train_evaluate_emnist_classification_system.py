...
custom_conv_net = ConvolutionalNetwork(  # initialize our network object, in this case a ConvNet
    ...
    num_output_classes=train_data.num_classes, num_filters=args.num_filters, num_layers=args.num_layers, stride=args.stride, dilation=args.dilation, dilation_grows=args.dilation_grows, use_bias=False)
